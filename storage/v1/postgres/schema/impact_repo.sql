...
CREATE TABLE IF NOT EXISTS traust_storage.impact_repo (
    ...
    l4_packages_found JSONB,
    govulncheck TEXT,
    govulncheck_trace JSONB,
    feature_pattern_matches BIGINT,
...
CREATE INDEX IF NOT EXISTS idx_impact_repo_classification
    ON traust_storage.impact_repo (classification);

CREATE INDEX IF NOT EXISTS idx_impact_repo_repo
    ON traust_storage.impact_repo (repo);
